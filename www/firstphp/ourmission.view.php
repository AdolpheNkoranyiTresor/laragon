...
<head>
    ...
    <title>Learning PHP Section Two</title>
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/ourmission.php" class="bg-gray-900 text-white hover:text-white rounded-md px-3 py-2 text-sm font-medium">Our Mission</a>
                </div>
            </div>
            </div>
